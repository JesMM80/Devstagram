...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- La directiva stack reserva ese espacio para cargar hojas de estilo que no se requiera en todas las vistas.
        En create.blade es donde cargamos finalmente la hoja de estilos específica, en concreto de dropzone --}}
        @stack('styles')
    ...
    <body class="bg-gray-100">
        ...
        <main class="container mx-auto mt-10">
            <h2 class="text-center font-black text-2xl mb-10"> @yield('titulo') </h2>
            @yield('contenido')
        </main>
